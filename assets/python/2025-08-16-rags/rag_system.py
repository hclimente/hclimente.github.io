...
class SimpleRAG:
    ...
    def __init__(self, qdrant_client: QdrantClient, collection_name: str, 
                 embedding_model, llm_model_name: str = "microsoft/gemma3-1b-instruct"):
        """
...
def create_rag_system(qdrant_client: QdrantClient, collection_name: str, 
                     embedding_model, model_choice: str = "qwen3-1.7b") -> SimpleRAG:
    """
