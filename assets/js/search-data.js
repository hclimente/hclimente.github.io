...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-our-preprint-on-predicting-cardiovascular-disease-risk-using-interpretable-ai-was-just-published-on-medrxiv-this-was-a-joint-work-with-microsoft-scientists",
          title: 'Our preprint on predicting cardiovascular disease risk using interpretable AI was just published...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%69%6E%66%6F@%68%63%6C%69%6D%65%6E%74%65.%65%75", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
