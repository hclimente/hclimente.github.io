...
Another limitation of SHAP values as presented [above](#shap-values) is that they force the explanation function to take an additive form, which **excludes feature interactions**.
...
The **permutation method** is the most efficient model-agnostic method to compute SHAP values.
