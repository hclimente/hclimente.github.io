...
I was lucky I am not a prolific writer, and I could compute all the distances. But this operation has a time complexity of $$O(N)$$ for the simple query, which makes it expensive for large collections. That's why I will focus on approximate methods, which produce good enough estimations of similarity in a reasonable time.
