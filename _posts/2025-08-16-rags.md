...
<div class="caption">
    Scatter plot of the two UMAP dimensions from the 384-dimensional embeddings computed by applying the [`all-MiniLM-L6-v2`](https://huggingface.co/sentence-transformers/all-MiniLM-L6-v2) LLM to my 1,160 chunks of text from my 32 blog posts. They are colored by their highest post of origin tag. Hover over the point to see the title of their post of origin and the first words of the chunked text.
</div>
...
For instance, here is the similarity matrix between all 1,160 text chunks:
...
<div class="caption">
    Pairwise cosine similarities between all 1,160 text chunks. Values with an absolute cosine similarity lower than 0.1 have been set to 0 to facilitate visualization.
</div>
