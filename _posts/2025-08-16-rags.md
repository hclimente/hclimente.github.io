...
<div class="caption">
    Pairwise cosine similarities between all 1,337 text chunks. Values with an absolute cosine similarity lower than 0.1 have been set to 0 to facilitate visualization.
</div>
...
[Small world graphs]({% post_url 2025-02-09-graph-properties %}#small-world-graph) are graphs with two key properties: small mean shortest-paths and high clustering coefficients.
